...
var IntroTS = (function (_super) {
    ...
    IntroTS.prototype.start = function (step) {
        ...
        window.addEventListener('resize', function () { return _this.block.updatePosition(_this._activeStep !== null ? _this._steps[_this._activeStep] : undefined); });
        this.dispatch('start');
        return this;
    };
