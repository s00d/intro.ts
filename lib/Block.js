...
var Block = (function () {
    ...
    Block.prototype.updatePosition = function (step) {
        (0, _setHelperLayerPosition_1._setHelperLayerPosition)(this.reference, this.helperElementPadding);
        (0, _setHelperLayerPosition_1._setHelperLayerPosition)(this.helper, this.helperElementPadding);
        if (step !== undefined) {
