...
var PosSetter_1 = require("./Helpers/PosSetter");
var _setHelperLayerPosition_1 = require("./Helpers/_setHelperLayerPosition");
var _getOffset_1 = require("./Helpers/_getOffset");
var Block = /** @class */ (function () {
    function Block(helperElementPadding, showStepNumbers, positionPrecedence) {
        ...
        this._posSetter = new PosSetter_1.PosSetter(showStepNumbers, positionPrecedence);
    }
    ...
    Block.prototype.updatePosition = function (step) {
        (0, _setHelperLayerPosition_1._setHelperLayerPosition)(this.targetElement, this.reference, this.helperElementPadding);
        (0, _setHelperLayerPosition_1._setHelperLayerPosition)(this.targetElement, this.helper, this.helperElementPadding);
        if (step !== undefined) {
    ...
    Block.prototype.generateOverlay = function () {
        ...
        if (!this.targetElement.tagName || this.targetElement.tagName.toLowerCase() === 'body') {
            ...
            var elementPosition = (0, _getOffset_1._getOffset)(this.targetElement);
            if (elementPosition) {
